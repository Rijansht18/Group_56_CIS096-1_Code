        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            if (rs.next()) {
                ...
                if ("ADMIN".equals(userType)) {
                    return Optional.of(new Admin(id, username, password, email, fullName,
                            rs.getString("role"), rs.getString("department")));
                } else {
                    return Optional.of(new Customer(id, username, password, email, fullName,
    ...
    public List<User> getAllUsers() {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                if ("ADMIN".equals(userType)) {
                    userList.add(new Admin(id, username, password, email, fullName,
                            rs.getString("role"), rs.getString("department")));
                } else {
                    userList.add(new Customer(id, username, password, email, fullName,
                            rs.getString("address"), rs.getString("phone_number")));
                }
            }
        } catch (SQLException e) {
    ...
    public List<Customer> getAllCustomers() {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                customerList.add(new Customer(id, username, password, email, fullName, address, phoneNumber));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public List<Admin> getAllAdmins() {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            while (rs.next()) {
                ...
                adminList.add(new Admin(id, username, password, email, fullName, role, department));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
